  ...
  return <div className="min-h-screen bg-drumio-intro-bg flex flex-col items-center justify-center px-6 py-8 relative overflow-hidden" dir={isRtl ? "rtl" : "ltr"}>
      ...
      <div className="flex flex-col items-center gap-12 max-w-sm w-full relative z-10">
        ...
        <div className="flex flex-col items-center gap-4">
          <div className="relative w-64 h-64 bg-cover bg-center bg-no-repeat rounded-full" style={{
          backgroundImage: `url(/lovable-uploads/ced3ac1d-0317-4c8a-9be2-23b8f68dac90.png)`
        }}></div>
      ...
      <div className="absolute top-[62%] right-8 transform rotate-8 opacity-80">
        <img src="/lovable-uploads/4cf55a02-424e-4546-ba5d-1dc675dfe9d5.png" alt="Musical note" className="w-12 h-16 opacity-80" />
      </div>
      
      <div className="absolute top-[45%] left-8 transform -rotate-12 opacity-60">
        <img src="/lovable-uploads/612e71c8-70fd-4a49-813e-0c89853f685b.png" alt="Musical note" className="w-8 h-12 opacity-60" />
      </div>
